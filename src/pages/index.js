              ...
              <div className="row gy-4">
                ...
                <div className="col-lg-8 ps-4 ps-lg-5">
                  ...
                  <div className="resume-section" data-aos="fade-up">
                    ...
                    <div className="resume-item">
                      <h4>Airline Booking System (Ongoing)</h4>
                      <h5>React | Express.js | PostgreSQL</h5>
                      <ul>
                        <li>Backend REST API design and database management</li>
                        <li>User & Admin modules with flight management</li>
                        <li>Secure booking logic and data flow handling</li>
                      </ul>
                    </div>
              ...
              <div className="row">
                ...
                <div className="col-lg-9">
                  ...
                  >
                    ...
                    <div className="col-lg-6 col-md-6 portfolio-item isotope-item filter-fullstack">
                      <div className="portfolio-wrap">
                        <img
                          src="img/portfolio/portfolio-airline.jpeg"
                          className="img-fluid"
                        ...
                        <div className="portfolio-info">
                          <div className="content">
                            ...
                            <div className="portfolio-links">
                              <a
                                href="img/portfolio/portfolio-airline.jpeg"
                                className="glightbox"
